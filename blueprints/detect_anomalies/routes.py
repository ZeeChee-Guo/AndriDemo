...
from utils.ml import norm_a_scoring, fit_user_labels, sand_scoring
...
def norm_a():
    ...
    result = norm_a_scoring(data, flags)
...
def norm_a_fit_user_labels():
    ...
    stable, intersect = fit_user_labels(scores, flags, training_set)
    print(intersect)

    return jsonify({'stable': stable, 'intersect': intersect})
