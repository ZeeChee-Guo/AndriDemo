...
def plot_cluster_color(X, cls, label, start=0, end=sys.maxsize, title="", marker="-", size_x=12, size_y=2, ylim=None,
                       lx=0.5, ly=1.5, ncol=None):
    colors = ['tab:blue', 'tab:orange', 'tab:green', 'tab:purple', 'tab:brown', 'tab:olive', 'tab:pink', 'tab:cyan',
              'tab:gray',
              'blue', 'orange', 'green', 'purple', 'brown', 'gold', 'violet', 'cyan', 'pink', 'deepskyblue',
              'lawngreen',
              'royalblue', 'darkgrey', 'darkorange', 'darkgreen', 'darkviolet', 'salmon', 'olivedrab', 'lightcoral',
...
################################################################################################################################
def plotFigRev(data, label, scores, slabels, slidingWindow, plotRange=None, y_pred=None, th=None, th_addd=None,
               fname='temp.png'):
    grader = metricor()
